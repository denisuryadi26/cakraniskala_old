...
@section('content')
    ...
    <!-- Modal -->
     @include('admin.contents.agama._modal')
@endsection
...
@section('script')
    ...
    <script type="text/javascript">
        var url = {
            detail : "{{route('dashboard_agamas_detail')}}",
            delete : "{{route('dashboard_agamas_delete')}}",
            submit : "{{route('dashboard_agamas_post')}}",
            table : "{{route('dashboard_agamas_table')}}"
        };
        var table;
