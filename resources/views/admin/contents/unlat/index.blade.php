...
@section('content')
    ...
    <!-- Modal -->
     @include('admin.contents.unlat._modal')
@endsection
...
@section('script')
    ...
    <script type="text/javascript">
        var url = {
            detail : "{{route('dashboard_unlats_detail')}}",
            delete : "{{route('dashboard_unlats_delete')}}",
            submit : "{{route('dashboard_unlats_post')}}",
            table : "{{route('dashboard_unlats_table')}}"
        };
        var table;
