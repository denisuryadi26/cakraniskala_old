            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" id="formModal" novalidate>
                    ...
                    <fieldset class="form-group floating-label-form-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Full Name" data-validation-required-message="This field is required">
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group floating-label-form-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" id="username" name="username" placeholder="User Name" data-validation-required-message="This field is required">
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group floating-label-form-group">
                        ...
                        <div class="controls">
                            ...
                            <select class="js-example-basic-single form-control" id="group" name="group_id">
