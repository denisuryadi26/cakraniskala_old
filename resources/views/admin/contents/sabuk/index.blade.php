...
@section('content')
    ...
    <!-- Modal -->
     @include('admin.contents.sabuk._modal')
@endsection
...
@section('script')
    ...
    <script type="text/javascript">
        var url = {
            detail : "{{route('dashboard_sabuks_detail')}}",
            delete : "{{route('dashboard_sabuks_delete')}}",
            submit : "{{route('dashboard_sabuks_post')}}",
            table : "{{route('dashboard_sabuks_table')}}"
        };
        var table;
