    ...
    <div class="col">
        <div class="card">
            ...
            <div class="table-responsive py-4">
                <table class="table table-flush table-hover" id="groupTable">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <table id="groupTable" class="table table-bordered dt-responsive nowrap table-hover table-striped" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            <th class="">#</th>
                            <th class="">Name</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#groupTable').on('init.dt', function() {
        ...
        $(document).on('click', '.access', function(e) {
            ...
            tbl_access = $('#accessTable').on('init.dt', function() {
                $('div.dataTables_length select').removeClass(
                    'custom-select custom-select-sm',
                );
            }).DataTable({
