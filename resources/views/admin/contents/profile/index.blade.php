                                    ...
                                    <div class="user-info-wrapper">
                                        ...
                                        <!-- <div class="d-flex flex-wrap my-50">
                                            <div class="user-info-title">
                                                ...
                                                <span class="card-text user-info-title font-weight-bold mb-0">VA Number :</span>
                                            </div>
                                            &nbsp;<p class="card-text mb-0">{{$profile->va_number}}</p>
                                        </div> -->
                                        <div class="d-flex flex-wrap my-50">
                                            <div class="user-info-title">
                ...
                <div class="col-md-5">
                    <div class="card-block">
                        ...
                        <div class="profile-img center">
                            <img class="img-thumbnail img-fluid img-center" style="max-height: 400px; max-width: 340px; margin-top: 5vh" src="{{ Auth::user()->profile_picture ? asset('storage/images/'.Auth::user()->profile_picture) : asset('datta-able/assets/images/user/avatar-4.jpg')}}" itemprop="thumbnail" alt="Profile Picture">
                        </div>
                    </div>
                </div>
