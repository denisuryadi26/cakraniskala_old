        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0" aria-labelledby="page-header-notifications-dropdown">
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                <img src="{{asset('nazox/assets/images/users/avatar-3.jpg')}}" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="media-body">
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                <img src="{{asset('nazox/assets/images/users/avatar-4.jpg')}}" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="media-body">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ Auth::user()->profile_picture ? asset('storage/images/'.Auth::user()->profile_picture) : asset('nazox/assets/images/users/admin-avatar.png')}}" alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ml-1">{{\Illuminate\Support\Facades\Auth::user()->username}}</span>
