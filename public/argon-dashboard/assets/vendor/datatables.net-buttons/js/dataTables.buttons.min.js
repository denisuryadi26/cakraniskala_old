...
(function (d) {
  ...
  d.extend(n.prototype, {
    ...
    add: function (a, b) {
      ...
      if ('string' === typeof b) {
        for (
          var e = b.split('-'), d = this.s, c = 0, f = e.length - 1;
          c < f;
          c++
        )
          d = d.buttons[1 * e[c]];
      ...
      for (
        ...
        if (o)
          if (d.isArray(o)) this._expandButton(a, o, c, e);
            ...
            j &&
              (e !== m ? (a.splice(e, 0, j), e++) : a.push(j),
              j.conf.buttons &&
                ((j.collection = d('<' + this.c.dom.collection.tag + '/>')),
                (j.conf._collection = j.collection),
                this._expandButton(j.buttons, j.conf.buttons, !0, e)),
              o.init && o.init.call(g.button(j.node), g, d(j.node), o),
              f++);
          }
      }
    },
    ...
    _popover: function (a, b, c) {
      ...
      'dt-container' === g.align &&
        ((f = f.parent()), c.css('width', l.width()));
      if ('absolute' === e) {
        e = f.position();
        ...
        (c.hasClass(g.rightAlignClassName) || 'button-right' === g.align) &&
          c.css('left', e.left + f.outerWidth() - j);
        o = e.left + j;
        l = l.offset().left + l.width();
        o > l && c.css('left', e.left - (o - l));
        l = f.offset().left + j;
        l > d(q).width() && c.css('left', e.left - (l - d(q).width()));
      } else
        (e = c.height() / 2),
          e > d(q).height() / 2 && (e = d(q).height() / 2),
          c.css('marginTop', -1 * e);
  ...
  n.instanceSelector = function (a, b) {
    ...
    var c = [],
      ...
      g = function (a) {
        if (d.isArray(a)) for (var h = 0, l = a.length; h < l; h++) g(a[h]);
        else
          'string' === typeof a
            ? -1 !== a.indexOf(',')
              ? g(a.split(','))
  ...
  i.Api.register('buttons().containers()', function () {
    ...
    this.iterator(!0, 'table', function (c) {
      if (c._buttons)
        for (
          var c = n.instanceSelector(b, c._buttons), d = 0, g = c.length;
          d < g;
          d++
        )
  ...
  i.Api.register('buttons.exportData()', function (a) {
    if (this.context.length) {
      ...
      b.select &&
        ...
        f.selected === m &&
        b.rows(c.rows, d.extend({ selected: !0 }, f)).any() &&
      ...
      for (
        ...
        for (var p = [l], r = 0; r < l; r++)
          (p[r] = c.format.body(f[j], n, r, h[j])), j++;
        k[n] = p;
      }
